...
aws_regexes: list[list[tuple[str, int | None]]] = [
...
extra_password_regexes: list[list[tuple[str, int | None]]] = [
...
def generate_default_sensitive_item_regexes() -> (
    list[list[tuple[re.Pattern[str], int | None]]]
):
...
def replace_matching_item(
    compiled_regexes: list[list[tuple[re.Pattern[str], int | None]]],
    input_line: str,
