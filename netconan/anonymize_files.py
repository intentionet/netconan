...
class FileAnonymizer:
    ...
    def __init__(
        ...
        self.compiled_regexes: list[list[tuple[re.Pattern[str], int | None]]] | None = (
            None
        )
...
def anonymize_files(
    ...
    if dumpfile is not None:
        with open(dumpfile, "w") as f_out:
            file_anonymizer.anonymizer4.dump_to_file(f_out)  # type: ignore[union-attr]
            file_anonymizer.anonymizer6.dump_to_file(f_out)  # type: ignore[union-attr]
